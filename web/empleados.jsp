                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Lista de Empleados</h1>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" name="tablaEmpleado" width="100%" cellspacing="0" style="display: block">
                                        <thead>
                                            <tr>
                                                <th>ID Empleado</th>
                                                <th>Documento</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <form name="formModificar" action="SvModify" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= empleado.getIdPersona()%>">
                                                        <button type="submit" class="btn btn-info" data-title="edit" style="display: inline">Modificar</button>
                                                    </form>
                                                </td>
                                                <td>
                                                    <form name="formEliminar" action="SvDelete" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= empleado.getIdPersona()%>">
