                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Lista de Huespedes</h1>
                        </div>

                        <!-- Content Row -->
                        <input type="button" value="Recargar Pagina" onClick="Location.reload();"
                               style="width: 150px; height: 30px; background: #CF6FA9; color: #ffffff; cursor: pointer; border-color: #CF6FA9; border-radius: 10px; margin-bottom: 20px;" />
                        <br>

                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Huespedes</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" name="tablaHuesped" width="100%" cellspacing="0" style="display: block">
                                        <thead>
                                            <tr>
                                                <th>ID Huesped</th>
                                                <th>Documento</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <%
                                                    ...
                                                    List<Huesped> listaHuespedes = control.getListaHuespedes();

                                                    for (Huesped huesped : listaHuespedes) {
                                                %>

                                                <td> <%= huesped.getIdPersona()%> </td>
                                                <td> <%= huesped.getDni()%> </td>
                                                <td> <%= huesped.getNombre()%> </td>
                                                <td> <%= huesped.getApellido()%> </td>
                                                <td> <%= huesped.getDireccion()%> </td>
                                                <td> <%= huesped.getTelefono()%> </td>
                                                <td> <%= huesped.getFechaNacimiento()%> </td>
                                                <td> <%= huesped.getProfesion()%> </td>

                                                <td>
                                                    <form name="formModificar" action="SvModifyHuesped" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= huesped.getIdPersona()%>">
                                                        <button type="submit" class="btn btn-info" data-title="edit" style="display: inline">Modificar</button>
                                                    </form>
                                                </td>
                                                <td>
                                                    <form name="formEliminar" action="SvDeleteHuesped" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= huesped.getIdPersona()%>">
