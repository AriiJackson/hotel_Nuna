                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Modificar Habitacion</h1>
                        </div>

                        <!-- Form -->
                        <form class="user" action="SvModifyHabitacion" method="GET">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                           placeholder="Ingrese el numero de habitación" name="idHabitacion" value="<%= habitacion.getIdHabitacion() %>">
                                </div>
                                <div class="col-sm-6">
                                    <label>Piso</label>
                                    <input type="text" class="form-control form-control-user" id="exampleLastName"
                                           placeholder="Ingrese el piso" name="piso" value="<%= habitacion.getPiso() %>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Tematica</label>
                                <input type="text" class="form-control form-control-user" id="exampleAdress"
                                       placeholder="Ingrese la tematica" name="tematica" value="<%= habitacion.getTematica() %>">
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label>Tipo de habitación</label>
                                    <select name="tipoHabitacion" class="form-control" value="<%= habitacion.getTipoHabitacion() %>">
                                ...
                                <div class="col-sm-6">
                                    <label>Precio</label>
                                    <input type="text" class="form-control" id="exampleLastName" placeholder="Ingrese el precio por noche" name="precio" value="<%= habitacion.getPrecio() %>">
                                </div>
                            </div>
                            <hr> 
                            <input type="hidden" value="<%= habitacion.getIdHabitacion() %>">
