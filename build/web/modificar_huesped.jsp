                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Modificar Huesped</h1>
                        </div>

                        <!-- Form -->
                        <form class="user" action="SvModifyHuesped" method="GET">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                           placeholder="Ingrese su nombre" name="nombre" value="<%= huesped.getNombre() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user" id="exampleLastName"
                                           placeholder="Ingrese su apellido" name="apellido" value="<%= huesped.getApellido() %>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Documento" name="dni" value="<%= huesped.getDni() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleDate" placeholder="" name="fechaNacimiento" value="<%= huesped.getFechaNacimiento() %>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Direccion" name="direccion" value="<%= huesped.getDireccion() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Telefono" name="telefono" value="<%= huesped.getTelefono() %>">
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleAdress"
                                       placeholder="Profesion" name="profesion" value="<%= huesped.getProfesion() %>">
                            </div>
                                       
                            <input type="hidden" value="<%= huesped.getIdPersona() %>">
