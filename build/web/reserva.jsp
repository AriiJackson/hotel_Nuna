                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Cargar una Reserva</h1>
                        </div>

                        <!-- Form -->
                        <form class="user" action="SvReserva" method="POST">
                            
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label>Fecha de Ingreso</label>
                                    <input type="Date" class="form-control datetimepicker-input form-control-user" name="fechaIngreso" data-target="#reservationdate">

                                </div>
                                <div class="col-sm-6">
                                    <label>Fecha de Egreso</label>
                                    <input type="Date" class="form-control datetimepicker-input form-control-user" name="fechaEgreso" data-target="#reservationdate">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="empleado" class="form-control">
                                        <option value="">¿Quien realizo esta reserva?</option>
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Huesped</label>
                                <select name="huesped" class="form-control">
                                        <option value="">¿Quien hace esta reserva?</option>
                                        <option value=""></option>
                                </select>
                            </div>
                            <hr>
