                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Lista de Habitaciones</h1>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" name="tablaHabitaciones" width="100%" cellspacing="0" style="display: block">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <%
                                                    ...
                                                    List<Habitacion> listaHabitaciones = control.getListaHabitacion();
                                                ...
                                                <td>
                                                    <form name="formModificar" action="SvModifyHabitacion" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= habitacion.getIdHabitacion()%>">
                                                        <button type="submit" class="btn btn-info" data-title="edit" style="display: inline">Modificar</button>
                                                    </form>
                                                </td>
                                                <td>
                                                    <form name="formEliminar" action="SvDeleteHabitacion" method="POST" style="display: inline">
                                                        <input type="hidden" name="id" value="<%= habitacion.getIdHabitacion()%>">
