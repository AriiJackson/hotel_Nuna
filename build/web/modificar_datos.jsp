            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Form -->
                        <form class="user" action="SvModify" method="GET">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                           placeholder="Ingrese su nombre" name="nombre" value="<%= empleado.getNombre() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user" id="exampleLastName"
                                           placeholder="Ingrese su apellido" name="apellido" value="<%= empleado.getApellido() %>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Documento" name="dni" value="<%= empleado.getDni() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleDate" placeholder="" name="fechaNacimiento" value="<%= empleado.getFechaNacimiento() %>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Direccion" name="direccion" value="<%= empleado.getDireccion() %>">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user"
                                           id="exampleAdress" placeholder="Telefono" name="telefono" value="<%= empleado.getTelefono() %>">
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleAdress"
                                       placeholder="Cargo" name="cargo" value="<%= empleado.getCargo() %>">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleUser"
                                       placeholder="Nombre de Usuario" name="usuario" value="<%= empleado.getUser() %>">

                            </div>
                                       
                            <input type="hidden" value="<%= empleado.getIdPersona() %>">
                            
                            <button class="btn btn-primary btn-user btn-block" type="submit"> Modificar </button>
